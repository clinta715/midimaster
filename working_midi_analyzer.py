...
import argparse
"""
Working MIDI Analyzer - Production Ready

This script provides comprehensive analysis of MIDI files using available tools.
"""
...
# Import available tools with error handling
try:
    import mido
    MIDO_AVAILABLE = True
except ImportError:
...
class AnalysisConfig:
    ...
    input_directory: str
    output_directory: str = "midi_analysis_output"
    max_workers: int = 4
    sample_visualizations: int = 2
...
class AnalysisResult:
    """Result of analysis for a single MIDI file."""
    file_path: str
    file_name: str
    file_size: int
    analysis_time: float
...
class WorkingMidiAnalyzer:
    """Main analyzer that orchestrates available analysis tools."""
...
<head>
    ...
    <title>MIDI Analysis Report</title>
    <style>
        body {{
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Working MIDI Analyzer - Production Ready",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  python working_midi_analyzer.py reference_midis/midi4
  python working_midi_analyzer.py reference_midis/midi4 --output my_analysis --workers 8
  python working_midi_analyzer.py reference_midis/midi4 --no-ml --sample-viz 5 --verbose
        """
    )

    parser.add_argument("input_directory", help="Directory containing MIDI files")
    parser.add_argument("--output", "-o", default="midi_analysis_output",
                       help="Output directory for results")
    parser.add_argument("--workers", "-w", type=int, default=4,
                       help="Maximum number of worker threads")
    parser.add_argument("--sample-viz", type=int, default=2,
    ...
    try:
        # Initialize analyzer
        analyzer = WorkingMidiAnalyzer(config)
